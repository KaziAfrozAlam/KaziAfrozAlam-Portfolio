  ...
  return (
    <Section id="projects" eyebrow="PROJECTS" bleed>
			...
			<div data-ev-id="ev_58cb6d3b8b">
				{projects.map((p) =>
        <div data-ev-id="ev_3cf40dfb2d" key={p.num} className="sticky top-0 min-h-[100svh] border-t border-line bg-ink">
						<div data-ev-id="ev_9c034e80fe" className="grid min-h-[100svh] grid-cols-1 lg:grid-cols-[1fr_40%]">
							{/* Left — documentation */}
